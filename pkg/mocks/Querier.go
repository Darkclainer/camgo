...
func (_m *Querier) Close(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *Querier) GetLemma(ctx context.Context, lemmaID string) ([]*parser.Lemma, error) {
...
func (_m *Querier) Search(ctx context.Context, query string) (string, []string, error) {
